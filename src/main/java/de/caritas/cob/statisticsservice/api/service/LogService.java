...
public class LogService {
  ...
  public static void logWarning(Exception exception) {
    LOGGER.warn("StatisticsService API: {}", getStackTrace(exception));
  }
  ...
  public static void logWarning(HttpStatus httpStatus, Exception exception) {
    LOGGER.warn("StatisticsService API: {}: {}", httpStatus.getReasonPhrase(),
  ...
  public static void logInternalServerError(Exception exception) {
    LOGGER.error("StatisticsService API: 500 Internal Server Error: {}", getStackTrace(exception));
  }
  ...
  public static void logError(Exception exception) {
    LOGGER.error("StatisticsService API: {}", getStackTrace(exception));
  }
}
